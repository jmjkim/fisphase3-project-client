...
const UpdateForm = () => {
    ...
    return (
        <form className="update_engine_form_container" onSubmit={( e ) => handleUpdateSubmit( e )}>
...
{/* <label>Engine ID </label><input type="text" name="manufactured_engine_id" value={ storedEngineObj.manufactured_engine_id } onChange={( e ) => handleEnginePartChange( e )} />
<label>VIN </label><input type="text" name="associated_vehicle_vin" value={ storedEngineObj.associated_vehicle_vin } onChange={( e ) => handleEnginePartChange( e )} />
<label>Layout </label><input type="text" name="engine_layout" value={ storedEngineObj.engine_layout } onChange={( e ) => handleEnginePartChange( e )} />
<label>Remark </label><input type="text" name="remark" value={ storedEngineObj.remark } onChange={( e ) => handleEnginePartChange( e )} maxLength="200" /> */}

{/* <label>Camshaft </label><input type="checkbox" name="camshaft_built" checked= { storedEngineObj.camshift_built } onChange={( e ) => handleEnginePartChange( e )} />
<label>Piston </label><input type="checkbox" name="piston_built" checked={ storedEngineObj.piston_built } onChange={( e ) => handleEnginePartChange( e )} />
<label>Flywheel </label><input type="checkbox" name="flywheel_built" checked={ storedEngineObj.flywheel_built } onChange={( e ) => handleEnginePartChange( e )} />
<label>Connecting Rod </label><input type="checkbox" name="connecting_rod_built" checked={ storedEngineObj.connecting_rod_built } onChange={( e ) => handleEnginePartChange( e )} />
<label>Crankshaft </label><input type="checkbox" name="crankshaft_built" checked={ storedEngineObj.crankshaft_built } onChange={( e ) => handleEnginePartChange( e )} />
<label>Sump </label><input type="checkbox" name="sump_built" checked={ storedEngineObj.sump_built } onChange={( e ) => handleEnginePartChange( e )} />
<label>Camshaft Drive Belt </label><input type="checkbox" name="camshaft_drive_belt_built" checked={ storedEngineObj.camshaft_drive_belt_built } onChange={( e ) => handleEnginePartChange( e )} /> */}
